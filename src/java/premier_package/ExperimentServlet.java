...
public class ExperimentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2>Informations concernant l'adresse IP et le navigateur utilisé par le client:</h2><br>");
            out.println("Adresse IP du client: "+ request.getRemoteAddr()+"<br>");
            out.println("Navigateur du client: "+ request.getRemoteAddr()+"<br>");
            out.println("<h2>Informations concernant la requête du client:</h2><br>");
            ...
            out.println("<h2>Informations concernant l'entête de la requête:</h2><br>");
            out.println("host: "+ request.getRemoteHost()+"<br>");
            out.println("user-agent: "+ "<br>");
            out.println("accept: "+ "<br>");
            out.println("accept-language: "+ "<br>");
            out.println("accept-encoding: "+ "<br>");
            out.println("accept-charset: "+ "<br>");
            out.println("keep-alive: "+ "<br>");
